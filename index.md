...
The package can be installed by enabling the “ropenscilabs” repository
from [r-universe](https://ropenscilabs.r-universe.dev):
...
command will then install the development version. Alternatively, the
